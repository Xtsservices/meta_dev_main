        ...
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="space-y-6">
            <div className="flex flex-col items-center text-center">
              <div className="w-12 h-12 rounded-full flex items-center justify-center mb-3" style={{backgroundColor: '#5de0e6'}}>
            ...
            <div className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-100 border-0 rounded-md focus:outline-none text-sm" onFocus={(e) => e.target.style.boxShadow = '0 0 0 2px #5de0e6'} onBlur={(e) => e.target.style.boxShadow = 'none'}
                />
                <input
                  type="email"
                  name="email"
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={4}
                className="w-full px-4 py-3 bg-gray-100 border-0 rounded-md focus:outline-none text-sm resize-none" onFocus={(e) => e.target.style.boxShadow = '0 0 0 2px #5de0e6'} onBlur={(e) => e.target.style.boxShadow = 'none'}
              ></textarea>
